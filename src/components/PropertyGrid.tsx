...
const PropertyGrid = () => {
  ...
  const properties = [
    ...
    },
    {
      ...
      price: 6500,
      rating: 4.8,
      imageUrl: "https://images.unsplash.com/photo-1590073242678-70ee3fc28e8e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    ...
    },
    {
      ...
      price: 4500,
      rating: 4.8,
      imageUrl: "https://images.unsplash.com/photo-1539650116574-75c0c6d57d45?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      category: "camping"
    },
    {
      id: 7,
